...
Update the tests as you see fit but absolutely do NOT run `bazel` commands to validate as it will fail. Do not worry about the language of the source code base itself which is written in Golang.
